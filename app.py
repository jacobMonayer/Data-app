        ...
        # If the user uploads an image
            if uploaded_file is not None:
                ...
                try:
                    ...
                    text = {0:'Septoria cannabis is a species of plant pathogen from the \n genus Septoria that causes the disease commonly known as Septoria leaf spot.\n Early symptoms of infection are concentric white lesions on the vegetative leaves of cannabis plants, followed by chlorosis and necrosis of the leaf until it is ultimately overcome by disease and all living cells are then killed. ' ,
                      1:'Powdery Mildew is arguable the most destructive Cannabis pest. It is an obligate biotroph that can vascularize into the plant tissue and remain invisible to a grower. It tends to emerge and sporulate 2 weeks into flowering thus destroying very mature crop with severe economic consequences. It is believed to travel in clones and it’s is not known if it travels in seeds. Early detection and eradication may be the safest approach.',
                      2:'Your Plant is healthy' ,
                      3:'TMV is a virus that is commonly found in tobacco plants which causes splotchy or twisted leaves, strange mottling symptoms, slowed growth, and reduced yields. TMV has spread to several other species of plants besides tobacco, including cannabis plants.Plants that get infected by TMV may not grow as fast or yield as well as they could have',
                      4: 'Spider mites are part of the mite family and are related to spiders, ticks, and other mites. Although they’re a common cannabis pest, they can be very difficult to get rid of.Spider mites have tiny sharp mouths that pierce individual plant cells and suck out the contents. This is what results in the tiny yellow, orange or white speckles you see on your plant leaves.Spider mites are common cannabis pests, especially when growing in soil. Although less common in hydroponics, spider mites can show up in any setup where cannabis is being cultivated.',
                      5:'Calcium deficiencies can be hard to diagnose. The leaves can have dead spots, crinkling, small brown spots, stunted growth, small or distorted leaves, curled tips, and dark green around the affected spots. Best way to restore is to flush your plants with clean pH neutral water, and then resupply the water nutrient solution.' ,
                      6:'Magnesium deficiency will give the veins and outer edges of your plant a light green-yellow color. Magnesium is a mobile nutrient and can travel from old leaves to new ones. Magnesium deficiency happens when the pH level is too low. Often the magnesium is present, but the roots cannot absorb it, therefore adding a magnesium supplement won’t help your plants. The best way to get that magnesium absorbed is to increase the pH.' }
